...
<head>
    ...
    <title>Activité | Mission humanitaire</title>
    <style>
        #translateBtn {
                    ...
                    <div class="section">
                        ...
                        <div class="container">
                            <div class="row text-center">
                                <div class="col">
                                    <img class="img-fluid fixed-size" src="assets/images/Activité7/image1.jpg" alt="">
                                </div>
                                <div class="col">
                                    <img class="img-fluid fixed-size" src="assets/images/Activité7/image2.jpg" alt="">
                                </div>
                            </div>
...
<script>
  ...
  function switchLanguage(lang) {
    ...
    if (langData) {
      ...
      document.getElementById('about-title8').textContent = langData["about-title8"];
      document.getElementById('about-text8').innerHTML = langData["about-text8"];
