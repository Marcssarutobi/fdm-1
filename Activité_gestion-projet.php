...
<head>
    ...
    <title>Activité | Gestion de projet</title>
</head>
                    ...
                    <div class="section content">
                        ...
                        <div class="container">
                            <div class="row text-center">
                                <div class="col">
                                    <img class="img-fluid fixed-size" src="assets/images/Activité2/image.jpg" alt="">
                                </div>
                                <div class="col">
                                    <img class="img-fluid fixed-size" src="assets/images/Activité2/img2.jpg" alt="">
                                </div>
                            </div>
                            <div class="row text-center mt-4">
                                <div class="col">
                                    <img class="img-fluid fixed-size" src="assets/images/Activité2/img3.jpg" alt="">
                                </div>
                                <div class="col">
                                    <img class="img-fluid fixed-size" src="assets/images/Activité2/img4.jpg" alt="">
                                </div>
                            </div>
                        </div>
