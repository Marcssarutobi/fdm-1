...
<head>
    ...
    <title>Activité | Management d'équipe</title>
</head>
                    ...
                    <div class="section content">
                        ...
                        <div class="container">
                            <div class="row text-center">
                                <div class="col">
                                    <img class="img-fluid fixed-size" src="assets/images/Activité5/6008046299892532262.jpg" alt="">
                                </div>
                                <div class="col">
                                    <img class="img-fluid fixed-size" src="assets/images/Activité5/img2.jpg" alt="">
                                </div>
                            </div>
                            <div class="row text-center mt-3">
                                <div class="col">
                                    <img class="img-fluid fixed-size" src="assets/images/Activité5/img3.jpg" alt="">
                                </div>
