...
<head>
    ...
    <title>Activité | Protection des droits</title>
    <style>
        #translateBtn {
                    ...
                    <div class="section">
                        ...
                        <div class="container">
                            <div class="row text-center">
                                <div class="col">
                                    <img class="img-fluid fixed-size" src="assets/images/Activité6/img.jpg" alt="">
                                </div>
                                <div class="col">
                                    <img class="img-fluid fixed-size" src="assets/images/Activité6/img2.jpg" alt="">
                                </div>
                            </div>
                            <div class="row text-center mt-3"> 
                                <div class="col">
                                    <img class="img-fluid fixed-size" src="assets/images/Activité6/img3.jpg" alt="">
                                </div>
                                <div class="col">
                                    <img class="img-fluid fixed-size" src="assets/images/Activité6/img4.jpg" alt="">
                                </div>
                            </div>
                            <div class="row text-center mt-3">
                                <div class="col">
                                    <img class="img-fluid fixed-size" src="assets/images/Activité6/img5.jpg" alt="">
                                </div>
                                <div class="col">
                                    <img class="img-fluid fixed-size" src="assets/images/Activité6/image.jpg" alt="">
                                </div>
                            </div>
                            <div class="row text-center mt-3">
                                <div class="col">
                                    <img class="img-fluid fixed-size" src="assets/images/Activité6/img7.jpg" alt="">
                                </div>
                                <div class="col">
                                    <img class="img-fluid fixed-size" src="assets/images/Activité6/img8.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
  ...
  function switchLanguage(lang) {
    ...
    if (langData) {
      ...
      document.getElementById('about-title5').textContent = langData["about-title5"];
