...
<html lang="fr">
  <head>
    ...
    />
    <title>Activité de sensibilisation</title>
  </head>
  <body>
    <!-- ***** Preloader Start ***** -->
    <div id="preloader">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="section">
              <p id="about-text6"></p>
               <p id="about-text7"></p><br>
              <center><h1 style="color: #FDB300;"id="responsables-title"></h1></center><br><br>
              <div class="container">
                <div class="row text-center">
                    <div class="col">
                        <img class="img-fluid fixed-size" src="assets/images/Activité1/img.jpg" alt="">
                    </div>
                    <div class="col">
                        <img class="img-fluid fixed-size" src="assets/images/Activité1/img2.jpg" alt="">
                    </div>
                </div> 
                <div class="row text-center mt-4"> 
                    <div class="col">
                        <img class="img-fluid fixed-size" src="assets/images/Activité1/image.jpg" alt="">
                    </div>
                    <div class="col">
                        <img class="img-fluid fixed-size" src="assets/images/Activité1/img4.jpg" alt="">
                    </div>
                </div>
              </div>
...
<script>
  ...
  function switchLanguage(lang) {
    ...
    if (langData) {
      ...
      document.getElementById('about-text6').innerHTML = langData["about-text6"];
      document.getElementById('about-text7').innerHTML = langData["about-text7"];
