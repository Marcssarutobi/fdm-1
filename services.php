...
<html lang="fr">
  <head>
    ...
    <title>Domaines d'intervention</title>
      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          ...
          <ul class="navbar-nav ml-auto ">
            ...
            <li class="nav-item active" ><a class="nav-link" href="services.php" id="services"></a></li>
      ...
      <div class="container">
        <div class="row" id="tabs">
          <div class="col-md-4">
            <ul>
              <li>
                <a href="#tabs-1" id="tab1"><i class="fa fa-angle-right"></i></a>
              </li>
              <li>
                <a href="#tabs-2" id="tab2"><i class="fa fa-angle-right"></i></a>
              </li>
              <li>
                <a href="#tabs-3" id="tab3"
                  ><i class="fa fa-angle-right"></i
                ></a>
              </li>
              <li>
                <a href="#tabs-4" id="tab4"
                  ><i
...
<script>
  ...
  function switchLanguage(lang) {
    ...
    if (langData) {
      ...
      document.getElementById('about-title6').textContent = langData["about-title6"];
      ...
      document.getElementById('tab1').textContent = langData.tab1;
      document.getElementById('tab2').textContent = langData.tab2;
      document.getElementById('tab3').textContent = langData.tab3;
      document.getElementById('tab4').textContent = langData.tab4;
      document.getElementById('tab5').textContent = langData.tab5;
      document.getElementById('titre1').textContent = langData.titre1;
      document.getElementById('titre2').textContent = langData.titre2;
      ...
      document.getElementById('desc4').textContent = langData.desc4;
      document.getElementById('desc5').textContent = langData.desc5;
